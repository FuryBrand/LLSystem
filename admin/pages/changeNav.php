...
<div id="second_nav">
	...
	<div class='row hide' style='margin:10px;font-size:16px' id="secNavAdd" novalidate="novalidate">
		<div class='col-lg-3'><input type='text' style='height:34px' id='newNav' placeholder='请输入新的名称' required/></div>
		<div class='col-lg-3'><input type='text' style='height:34px' id='href' placeholder='请输入链接地址' required/></div>
