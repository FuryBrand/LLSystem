	...
	<div class="row" style="margin-bottom:20px;">
		<div class='col-lg-3'>
			<input type="text" style="width:100%;height:34px" id="newsType<?php echo $news_type[$i]['id'] ?>" value="<?php echo $news_type[$i]['name'] ?>">
		</div>
		<div class='col-lg-2'>
			<input type="button" id="btn" class="btn btn-warning" value="修改" onclick="updateNewsType(<?php echo $news_type[$i]['id'] ?>)"/>
