	...
	?>
	<div class="row" style="font-size:17px;margin-bottom:25px;">
	...
	<div class="row">
		<div class='col-lg-3'>
			...
			<div style="margin:10px 0">
				...
				<input type="button" class="btn btn-info" value="修改" style="margin-left:10px" onclick="updateCompany()"/>
			</div>
			<div>
				<input type="text" class="form-style" style="width:70%;height:34px" id="addCompany" placeholder="请输入新的公司">
				<input type="button" class="btn btn-info" value="添加" style="margin-left:10px" onclick="newCompany()"/>
			</div>
		</div>
		<div class='col-lg-3'>
			<div style="margin:15px 0">
			...
			<div style="margin:10px 0">
				...
				<input type="button" class="btn btn-info" value="修改" style="margin-left:10px" onclick="updateSeries()"/>
			</div>
			<div>
				<input type="text" class="form-style" style="width:70%;height:34px" id="addSeries" placeholder="请输入新的系列" >
				<input type="button" class="btn btn-info" value="添加" style="margin-left:10px" onclick="newSeries()"/>
			</div>
		</div>
	</div>
