	...
	<div class="row margin-top30">
		...
		<div class="col-lg-6 col-md-5 col-sm-6 col-xs-12 margin-top10">
			<div>
				<form method="post" action="./controller/ajax.php?fun=search">
					<div style="float:right">
						<div class="search">
							...
							<input type="submit" value="搜索" class="btn btn-info" style="width:6 0px;height:26px;line-height:10px;vertical-align: top;">
						</div>
					</div>
				</form>
			</div>
