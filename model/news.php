...
//lwx:改
function update_news($id,$title,$type){
	$sql="UPDATE news SET type='".$type."', title='".$title."' WHERE id='".$id."'";
	return run_sql($sql);
}
//lwx:改一个字段
...
function get_news_by_id($id){
	$sql = "SELECT n.id,n.title,n.content,n.thumb,n.create_date,n.type,f.name FROM news n LEFT JOIN fk_news_type f ON n.type=f.id WHERE n.id=$id";
